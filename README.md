...
<ol> 
    <li> In this notebook we have plotted and analyzed many features. observations relating to the plots are in markdown cells below every plot.</li>
    <li>
        <ul>Built the data matrix using the features mentioned below :
    ...
    <li> Then plotted FOUR t-SNE plots with each of these feature sets.
        <ol>
            <li>categorical, numerical features + project_title(Bag Of Words)</li>
    ...
    <li> Concatenated all the features and Applied TNSE on the final data matrix </li>
    <li> <font color='blue'>Note : Since TSNE accepts only dense matrices I have Considered only 5k to 6k data points to avoid memory issues.</font></li>
</ol>
